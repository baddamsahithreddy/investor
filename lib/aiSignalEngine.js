  ...
  for (const stock of stocks) {
    try {
      const [
        ...
        getRSI(stock.priceHistory),                   // FIXED: no symbol, only price history
        getVolumeSpike(stock.volumeData),             // FIXED: pass only volumeData
      ...
      const confidence = calculateConfidence({
        rsi: rsiData.value,
        volume: volumeData.category,                  // FIXED
        earningsImpact,
